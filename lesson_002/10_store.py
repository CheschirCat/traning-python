...
table_cost = ((table_quantity * table_price) + (table_price1 * table_quantity1))
...
sofa_cost = ((sofa_quantity * sofa_price) + (sofa_price1 * sofa_quantity1))
...
chair_cost = ((chair_quantity * chair_price) + (chair_price1 * chair_quantity1) + (chair_price2 * chair_quantity2))
