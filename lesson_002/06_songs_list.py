...
songs_summ = violator_songs_list[3][1] + violator_songs_list[5][1] + violator_songs_list[8][1]
...
songs_summ2 = violator_songs_dict['Sweetest Perfection'] + violator_songs_dict['Policy of Truth'] + violator_songs_dict['Blue Dress']

print('А другие три песни звучат: ', round(songs_summ2, 2), 'минуты')
